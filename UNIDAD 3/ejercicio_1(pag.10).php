...
<body>
    <form action="#" method="get">
        ...
        <input type="text" name="apellido" id="apellido" <?php if(!empty($_REQUEST["apellido"])):?> value="<?php echo $_REQUEST['apellido'];?>" <?php endif;?> required>    
    ...
    <?php
        if(isset ($_REQUEST['nombre']) && isset($_REQUEST['email'])  && isset($_REQUEST['comentario']) && isset($_REQUEST['apellido'])) {
            $nombre = $_GET['nombre'];
